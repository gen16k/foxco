...
- ~~LFM2.5-1.2B-JP-202606の実行ランタイムは何を使うか~~ → **解決済み**: llama.cpp サイドカー (Vulkan build) を採用。AMD Ryzen AI APU の内蔵 Radeon iGPU にオフロード (`-ngl 99`)。CPU フォールバックあり。詳細は `proxy-server/docs/spec-proxy.md`
