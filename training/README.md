...
Current baseline result is an initial check on the first 10 validation rows. It is reproducible, but not a final benchmark. See `training/evaluation/Evaluation_Result.md` for limitations.
